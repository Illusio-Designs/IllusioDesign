    ...
    return (
        <>
            ...
            <div className="main project">
                            ...
                            <div data-anim-delay="" className="columns__col mod--blog-hero is-1">
                                <div className="catalog-card-border">
                                    <div className="heading-wrap mod--catalog-border">
                                        <h1 className="heading-1 mod--catalog-border">OUR <br />BEST <br />WORKS</h1>
                                    </div>
                                    <div className="catalog-card-border__bottom">
                                        <div className="catalog-card-border__content">
                                            <div className="catalog-card-border__advant">
                                                <div className="catalog-card-border__advant-numb">500+</div>
                                                <div className="catalog-card-border__advant-text is-1">projects <br />done</div>
                                                <div className="catalog-card-border__advant-text is-2">350+ projects <br />done</div>
                                            </div>
                                            <a href="#posts" data-hover="" className="button-flex w-inline-block">
                                                <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/644a822df3c2ce4b21e19455_icon-hero-project.svg" loading="eager" data-hover-elem="" alt="" className="icon-scale is-1" />
                                                <div className="button is-small-simple bg-color-yellow">
                                                    <div className="button__overflow">
                                                        <div data-hover-elem="" className="button__texts">
                                                            <div className="button__text">all cases</div>
                                                            <div className="button__text is-absolute">all cases</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </a>
                            ...
                            <div data-anim-delay="100" className="columns__col mod--blog-hero">
                                <div data-swiper="projects-hero" className="swiper mod--projects-hero w-dyn-list swiper-fade swiper-initialized swiper-horizontal swiper-pointer-events swiper-watch-progress swiper-backface-hidden">
                                        ...
                                        <div role="group" className="swiper-slide mod--projects-hero2 w-dyn-item" style={{ width: '676px', transitionDuration: '0ms', opacity: 1, transform: 'translate3d(0px, 0px, 0px)' }} aria-label="1 / 3">
                                            <a data-hover="" data-mask="projects-big-invert" href="/project/bookclub24" className="catalog-card-fill mod--projects w-inline-block">
                                                <div className="catalog-card-fill__img-wrap">
                                                    <img alt="Bookclub24 Project" loading="lazy" data-hover-elem="" src="https://cdn.prod.website-files.com/63fc977c14aaea404dce4439/66bca4ca83d2ecd1513bd872_Preview.webp" sizes="(max-width: 479px) 96vw, (max-width: 767px) 50vw, 48vw" srcSet="https://cdn.prod.website-files.com/63fc977c14aaea404dce4439/66bca4ca83d2ecd1513bd872_Preview-p-500.webp 500w, https://cdn.prod.website-files.com/63fc977c14aaea404dce4439/66bca4ca83d2ecd1513bd872_Preview-p-800.webp 800w, https://cdn.prod.website-files.com/63fc977c14aaea404dce4439/66bca4ca83d2ecd1513bd872_Preview-p-1080.webp 1080w, https://cdn.prod.website-files.com/63fc977c14aaea404dce4439/66bca4ca83d2ecd1513bd872_Preview.webp 1280w" className="post-card__img is-full" />
                                                </div>
                                                <div className="catalog-card-fill__content mod--projects">
                                                    <div data-anim-delay="500" className="post-card__param is--big">
                                                        ...
                                                        <div className="project__flags">
                                                            <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/66ab5672df09cccbbfafb714_flag-USA.avif" loading="lazy" alt="USA Flag" className="project__flag w-condition-invisible" />
                                                            <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/66ab5672e16ef9cd94f1e9e2_flag-UK.avif" loading="lazy" alt="UK Flag" className="project__flag w-condition-invisible" />
                                                            <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/66ab5671b25d942cf11814bb_flag-France.avif" loading="lazy" alt="France Flag" className="project__flag w-condition-invisible" />
                                                            <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/66ab567120213631b7c6753e_flag-Canada.avif" loading="lazy" alt="Canada Flag" className="project__flag w-condition-invisible" />
                                                            <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/66ab56714b5a386eb1600483_flag-Switzerland.avif" loading="lazy" alt="Switzerland Flag" className="project__flag w-condition-invisible" />
                                                            <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/66ab5671a671d71d454caddd_flag-Germany.avif" loading="lazy" alt="Germany Flag" className="project__flag" />
                                                            <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/66ab5671023787dcce26339d_flag-Israel.avif" loading="lazy" alt="Israel Flag" className="project__flag w-condition-invisible" />
                                                            <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/66ab5672ec5e919df8d160f6_flag-Morocco.avif" loading="lazy" alt="Morocco Flag" className="project__flag w-condition-invisible" />
                                                            <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/66ab5671ae9087758803caf2_flag-Singapore.avif" loading="lazy" alt="Singapore Flag" className="project__flag w-condition-invisible" />
                                                            <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/66ab5672e2404c133f3db7e5_flag-Taiwan.avif" loading="lazy" alt="Taiwan Flag" className="project__flag w-condition-invisible" />
                                                            <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/66ab5671e2b9b5a9fbf66ca7_flag-Ukraine.avif" loading="lazy" alt="Ukraine Flag" className="project__flag w-condition-invisible" />
                                                            <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/66ab5671023787dcce263398_flag-Austria.avif" loading="lazy" alt="Austria Flag" className="project__flag w-condition-invisible" />
                                                    ...
                                                    <h3 className="heading-6 text-style-2lines">Digital rebirth of Bookclub24 — #1 German online library for book collectors</h3>
                                                </div>
                                            </a>
                                        </div>
                                        <div role="group" className="swiper-slide mod--projects-hero2 w-dyn-item swiper-slide-prev" style={{ width: '676px', transitionDuration: '0ms', opacity: 1, transform: 'translate3d(-676px, 0px, 0px)' }} aria-label="2 / 3">
                                            <a data-hover="" data-mask="projects-big-invert" href="/project/raven" className="catalog-card-fill mod--projects w-inline-block">
                                                <div className="catalog-card-fill__img-wrap">
                                                    <img alt="Raven Project" loading="lazy" data-hover-elem="" src="https://cdn.prod.website-files.com/63fc977c14aaea404dce4439/66bc97b574f90949e42aec3c_Preview.webp" sizes="(max-width: 479px) 96vw, (max-width: 767px) 50vw, 48vw" srcSet="https://cdn.prod.website-files.com/63fc977c14aaea404dce4439/66bc97b574f90949e42aec3c_Preview-p-500.webp 500w, https://cdn.prod.website-files.com/63fc977c14aaea404dce4439/66bc97b574f90949e42aec3c_Preview-p-800.webp 800w, https://cdn.prod.website-files.com/63fc977c14aaea404dce4439/66bc97b574f90949e42aec3c_Preview-p-1080.webp 1080w, https://cdn.prod.website-files.com/63fc977c14aaea404dce4439/66bc97b574f90949e42aec3c_Preview.webp 1280w" className="post-card__img is-full" />
                                                </div>
                                                <div className="catalog-card-fill__content mod--projects">
                                                    <div data-anim-delay="500" className="post-card__param is--big">
                                                        <div className="collection is-nest w-dyn-list">
                                                        ...
                                                        <div className="project__flags">
                                                            <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/66ab5672df09cccbbfafb714_flag-USA.avif" loading="lazy" alt="USA Flag" className="project__flag w-condition-invisible" />
                                                            <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/66ab5672e16ef9cd94f1e9e2_flag-UK.avif" loading="lazy" alt="UK Flag" className="project__flag" />
                                                            <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/66ab5671b25d942cf11814bb_flag-France.avif" loading="lazy" alt="France Flag" className="project__flag w-condition-invisible" />
                                                            <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/66ab567120213631b7c6753e_flag-Canada.avif" loading="lazy" alt="Canada Flag" className="project__flag w-condition-invisible" />
                                                            <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/66ab56714b5a386eb1600483_flag-Switzerland.avif" loading="lazy" alt="Switzerland Flag" className="project__flag w-condition-invisible" />
                                                            <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/66ab5671a671d71d454caddd_flag-Germany.avif" loading="lazy" alt="Germany Flag" className="project__flag w-condition-invisible" />
                                                            <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/66ab5671023787dcce26339d_flag-Israel.avif" loading="lazy" alt="Israel Flag" className="project__flag w-condition-invisible" />
                                                            <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/66ab5672ec5e919df8d160f6_flag-Morocco.avif" loading="lazy" alt="Morocco Flag" className="project__flag w-condition-invisible" />
                                                            <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/66ab5671ae9087758803caf2_flag-Singapore.avif" loading="lazy" alt="Singapore Flag" className="project__flag w-condition-invisible" />
                                                            <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/66ab5672e2404c133f3db7e5_flag-Taiwan.avif" loading="lazy" alt="Taiwan Flag" className="project__flag w-condition-invisible" />
                                                    ...
                                                    <h3 className="heading-6 text-style-2lines">Raven.gg — the leading brand for custom esports clothing design</h3>
                                                </div>
                                            </a>
                                        </div>
                                        <div role="group" className="swiper-slide mod--projects-hero2 w-dyn-item swiper-slide-visible swiper-slide-active" aria-label="3 / 3" style={{ width: '676px', transitionDuration: '0ms', opacity: 1, transform: 'translate3d(-1352px, 0px, 0px)' }}>
                                            <a data-hover="" data-mask="projects-big-invert" href="/project/mighty-buildings" className="catalog-card-fill mod--projects w-inline-block">
                                                <div className="catalog-card-fill__img-wrap">
                                                    <img alt="Mighty Buildings Project" loading="lazy" data-hover-elem="" src="https://cdn.prod.website-files.com/63fc977c14aaea404dce4439/66bc9fd5a182865b10c705af_Preview.webp" sizes="(max-width: 479px) 96vw, (max-width: 767px) 50vw, 48vw" srcSet="https://cdn.prod.website-files.com/63fc977c14aaea404dce4439/66bc9fd5a182865b10c705af_Preview-p-500.webp 500w, https://cdn.prod.website-files.com/63fc977c14aaea404dce4439/66bc9fd5a182865b10c705af_Preview-p-800.webp 800w, https://cdn.prod.website-files.com/63fc977c14aaea404dce4439/66bc9fd5a182865b10c705af_Preview-p-1080.webp 1080w, https://cdn.prod.website-files.com/63fc977c14aaea404dce4439/66bc9fd5a182865b10c705af_Preview.webp 1280w" className="post-card__img is-full" />
                                                </div>
                                                <div className="catalog-card-fill__content mod--projects">
                                                    <div data-anim-delay="500" className="post-card__param is--big">
                                                        <div className="collection is-nest w-dyn-list">
                                                        ...
                                                        <div className="project__flags">
                                                            <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/66ab5672df09cccbbfafb714_flag-USA.avif" loading="lazy" alt="USA Flag" className="project__flag" />
                                                            <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/66ab5672e16ef9cd94f1e9e2_flag-UK.avif" loading="lazy" alt="UK Flag" className="project__flag w-condition-invisible" />
                                                            <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/66ab5671b25d942cf11814bb_flag-France.avif" loading="lazy" alt="France Flag" className="project__flag w-condition-invisible" />
                                                            <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/66ab567120213631b7c6753e_flag-Canada.avif" loading="lazy" alt="Canada Flag" className="project__flag w-condition-invisible" />
                                                            <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/66ab56714b5a386eb1600483_flag-Switzerland.avif" loading="lazy" alt="Switzerland Flag" className="project__flag w-condition-invisible" />
                                    ...
                                    <div data-anim-delay="500" className="catalog-hero__pagination">
                                        <div data-swiper-pagination-style="load" data-swiper-pagination="projects-hero" className="swiper-pagin mod--catalog-hero swiper-pagination-clickable swiper-pagination-bullets swiper-pagination-horizontal">
                ...
                <div className="section z-index-3">
                    ...
                    <div className="columns mod--projects">
                        <div className="columns__col mod--projects is--1">
                            <div data-sidebar-sticky="" className="projects-sidebar">
                                    ...
                                    <form id="wf-form-sort" name="wf-form-sort" data-name="sort" method="get" className="form mod--projects-sort" aria-label="sort">
                                        <div className="projects-sort__dropdowns">
                                            <div data-delay="0" data-hover="false" data-dropdown-industries="" className="dropdown-inter-each mod--projects-sort active w-dropdown">
                                                <div className="dropdown__toggle mod--projects-sort w-dropdown-toggle" id="w-dropdown-toggle-3" aria-controls="w-dropdown-list-3" aria-haspopup="menu" aria-expanded="false" role="button" tabIndex="0">
                                                    <div className="projects-sidebar__title-wrap">
                                                        <div>INDUSTRIES</div>
                                                        <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/6672e0ff9cd586d2e15fd87a_icon-checked-yellow_filled.svg" loading="lazy" alt="" className="projects-sidebar__check is--filled" />
                                                    </div>
                                                    <div data-dropdown-arrow-each="" className="icon-regular mod--projects-sort w-embed">
                                                        <svg aria-hidden="true" role="img" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="100%" height="100%">
                                                            <path fillRule="evenodd" d="M5.293 8.293a1 1 0 0 1 1.414 0L12 13.586l5.293-5.293a1 1 0 1 1 1.414 1.414l-6 6a1 1 0 0 1-1.414 0l-6-6a1 1 0 0 1 0-1.414Z" clipRule="evenodd"></path>
                                                        </svg>
                                                    </div>
                                                </div>
                                                <div className="dropdown__list is-inter w-dropdown-list" style={{ height: 'auto' }} id="w-dropdown-list-3" aria-labelledby="w-dropdown-toggle-3">
                                                    <div className="dropdown__content mod--projects-sort">
                                                        ...
                                                        <div className="collection w-dyn-list">
                                                            <div role="list" className="collection__list mod--projects-sort w-dyn-items">
                                            ...
                                            <div data-delay="0" data-hover="false" data-dropdown-services="" className="dropdown-inter-each w-dropdown">
                                                <div className="dropdown__toggle mod--projects-sort is-last w-dropdown-toggle" id="w-dropdown-toggle-4" aria-controls="w-dropdown-list-4" aria-haspopup="menu" aria-expanded="false" role="button" tabIndex="0">
                                                    <div className="projects-sidebar__title-wrap">
                                                        <div>SERVICES</div>
                                                        <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/6672e0ff9cd586d2e15fd87a_icon-checked-yellow_filled.svg" loading="lazy" alt="" className="projects-sidebar__check is--filled" />
                                                    </div>
                                        ...
                                        <input type="hidden" name="Page of submit" id="input-02-0" value="https://www.halo-lab.com/projects" />
                                ...
                                <div className="projects-sidebar__buttons">
                                    <div href="#discuss" data-remodal-target="booking" data-hover="" className="button mod--projects-cta">
                                        <div className="button__overflow">
                                            <div data-hover-elem="" className="button__texts">
                                                <div className="button__text">Have a project?</div>
                                                <div className="button__text is-absolute">Have a project?</div>
                                            </div>
                                        </div>
                                        <div data-hover-elem="" className="button__icons is-white hide-mobile-portrait">
                                    ...
                                    <div data-filter-state="" data-filter-btn="" className="button mod--projects-filter">
                                        <div className="button__overflow hide-mobile-portrait">
                                            <div data-hover-elem="" className="button__texts">
                                                <div className="button__text">Filters</div>
                                                <div className="button__text is-absolute">Filters</div>
                                            </div>
                                        </div>
                                        <div data-filter-icon="" className="button__icons mod--projects-filter">
                                            ...
                                            <div className="button__bg bg-color-black"></div>
                                            <div className="button__filter-dot"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="heading-wrap mod--projects-catalog is-mobile w-clearfix">
                            <div className="space-heading-4"></div>
                            <h4 className="heading-4">We've helped over 350 firms reach their full potential, and we're happy to do the same for you! Find out how our skills can contribute to your success.</h4>
                        </div>
                        <div className="columns__col mod--projects is--2">
                            <div className="heading-wrap mod--projects-catalog hide-mobile-landscape w-clearfix">
                                <div className="space-heading-4"></div>
                                <h4 className="heading-4">We've helped over 350 firms reach their full potential, and we're happy to do the same for you! Find out how our skills can contribute to your success.</h4>
                            </div>
                            <div data-projects-tags="" className="projects-tags-wrap hide-tablet" style={{ display: 'none' }}>
                                <div className="projects-tags">
                                    <div className="opacity-70">You're looking for:</div>
                            ...
                            <div className="collection w-dyn-list">
                                <div className="collection__list is-posts w-dyn-items" role="list">
                                    <div role="listitem" className="collection__item is-posts is-2col w-dyn-item" style={{ opacity: 1 }}>
                                        <div data-hover-parent="" className="post-card">
                                            ...
                                            <div className="post-card__param">
                                                ...
                                                <div className="project__flags">
                                                    <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/66ab5672df09cccbbfafb714_flag-USA.avif" loading="lazy" alt="" className="project__flag" />
                                                    <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/66ab5672e16ef9cd94f1e9e2_flag-UK.avif" loading="lazy" alt="" className="project__flag w-condition-invisible" />
                                                    <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/66ab5671b25d942cf11814bb_flag-France.avif" loading="lazy" alt="" className="project__flag w-condition-invisible" />
                                                    <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/66ab567120213631b7c6753e_flag-Canada.avif" loading="lazy" alt="" className="project__flag w-condition-invisible" />
                                                    <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/66ab56714b5a386eb1600483_flag-Switzerland.avif" loading="lazy" alt="" className="project__flag w-condition-invisible" />
                                                    <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/66ab5671a671d71d454caddd_flag-Germany.avif" loading="lazy" alt="" className="project__flag w-condition-invisible" />
                                                    <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/66ab5671023787dcce26339d_flag-Israel.avif" loading="lazy" alt="" className="project__flag w-condition-invisible" />
                                                    <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/66ab5672ec5e919df8d160f6_flag-Morocco.avif" loading="lazy" alt="" className="project__flag w-condition-invisible" />
                                                    <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/66ab5671ae9087758803caf2_flag-Singapore.avif" loading="lazy" alt="" className="project__flag w-condition-invisible" />
                                                    <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/66ab5672e2404c133f3db7e5_flag-Taiwan.avif" loading="lazy" alt="" className="project__flag w-condition-invisible" />
                                                    <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/66ab5671e2b9b5a9fbf66ca7_flag-Ukraine.avif" loading="lazy" alt="" className="project__flag w-condition-invisible" />
                                                    <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/66ab5671023787dcce263398_flag-Austria.avif" loading="lazy" alt="" className="project__flag w-condition-invisible" />
                                                    <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/66ab56714767af99cb4cdbb0_flag-Spain.avif" loading="lazy" alt="" className="project__flag w-condition-invisible" />
                                                    <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/66ab5671d3b5aa2c153e2e85_flag-Norway.avif" loading="lazy" alt="" className="project__flag w-condition-invisible" />
                                                    <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/66ab567137517ac50d28ad82_flag-Netherlands.avif" loading="lazy" alt="" className="project__flag w-condition-invisible" />
                                                    <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/67bda237b702f3e3c050d9ee_flag-UAE.avif" loading="lazy" alt="" className="project__flag w-condition-invisible" />
                                                    <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/67c06382ce089ee9cac4fabf_flag-Portugal.avif" loading="lazy" alt="" className="project__flag w-condition-invisible" />
                                                </div>
                                            </div>
                                            <a data-hover="" href="/project/zolve" className="post-card__title-link w-inline-block">
                                                <h2 className="post-card__title">Making users' lives greener with a UI/UX that feels like nature's touch<span className="post-card__span-icons"></span><span className="post-card__span-icons">
                                    ...
                                    <div role="listitem" className="collection__item is-posts is-2col w-dyn-item" style={{ opacity: 1 }}>
                                        <div data-hover-parent="" className="post-card">
                                            ...
                                            <a data-hover="" href="/project/hospity" className="post-card__title-link w-inline-block">
                                                <h2 className="post-card__title">Visionary, one-of-a-kind design for an advanced medical platform<span className="post-card__span-icons"></span><span className="post-card__span-icons">
                                                    <div className="post-card__icons">
                                                        <div className="post-card__icon opacity-0 w-embed">
                                                            <svg aria-hidden="true" role="img" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19 19" width="100%" height="100%">
                                                                <path fillRule="evenodd" d="M6.25.879 14.871 9.5l-8.62 8.622L4.128 16l6.5-6.5-6.5-6.5L6.25.88Z" clipRule="evenodd"></path>
                                    ...
                                    <div role="listitem" className="collection__item is-posts is-2col w-dyn-item" style={{ opacity: 1 }}>
                                        <div data-hover-parent="" className="post-card">
                                            ...
                                            <div className="post-card__param">
                                                ...
                                                <div className="project__flags">
                                                    <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/66ab5672df09cccbbfafb714_flag-USA.avif" loading="lazy" alt="" className="project__flag w-condition-invisible" />
                                                    <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/66ab5672e16ef9cd94f1e9e2_flag-UK.avif" loading="lazy" alt="" className="project__flag w-condition-invisible" />
                                                    <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/66ab5671b25d942cf11814bb_flag-France.avif" loading="lazy" alt="" className="project__flag w-condition-invisible" />
                                                    <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/66ab567120213631b7c6753e_flag-Canada.avif" loading="lazy" alt="" className="project__flag w-condition-invisible" />
                                                    <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/66ab56714b5a386eb1600483_flag-Switzerland.avif" loading="lazy" alt="" className="project__flag w-condition-invisible" />
                                            ...
                                            <a data-hover="" href="/project/relocate-now" className="post-card__title-link w-inline-block">
                                                <h2 className="post-card__title">Relocate Now — a memorable brand story inspired by home<span className="post-card__span-icons"></span><span className="post-card__span-icons">
                                                    <div className="post-card__icons">
                                                        <div className="post-card__icon opacity-0 w-embed">
                                                            <svg aria-hidden="true" role="img" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19 19" width="100%" height="100%">
                                                                <path fillRule="evenodd" d="M6.25.879 14.871 9.5l-8.62 8.622L4.128 16l6.5-6.5-6.5-6.5L6.25.88Z" clipRule="evenodd"></path>
                                    ...
                                    <div role="listitem" className="collection__item is-posts is-2col w-dyn-item" style={{ opacity: 1 }}>
                                        <div data-hover-parent="" className="post-card">
                                            ...
                                            <a data-hover="" href="/project/asi-app" className="post-card__title-link w-inline-block">
                                                <h2 className="post-card__title">Designing an AI-powered learning app for modern education needs<span className="post-card__span-icons"></span><span className="post-card__span-icons">
                                                    <div className="post-card__icons">
                                                        <div className="post-card__icon opacity-0 w-embed">
                                                            <svg aria-hidden="true" role="img" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19 19" width="100%" height="100%">
                                                                <path fillRule="evenodd" d="M6.25.879 14.871 9.5l-8.62 8.622L4.128 16l6.5-6.5-6.5-6.5L6.25.88Z" clipRule="evenodd"></path>
                                    ...
                                    <div role="listitem" className="collection__item is-posts is-2col w-dyn-item" style={{ opacity: 1 }}>
                                        <div data-hover-parent="" className="post-card">
                                            ...
                                            <a data-hover="" href="/project/clawerly" className="post-card__title-link w-inline-block">
                                                <h2 className="post-card__title">A clever take on design for a smarter language learning platform <span className="post-card__span-icons"></span><span className="post-card__span-icons">
                                                    <div className="post-card__icons">
                                                        <div className="post-card__icon opacity-0 w-embed">
                                                            <svg aria-hidden="true" role="img" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19 19" width="100%" height="100%">
                                                                <path fillRule="evenodd" d="M6.25.879 14.871 9.5l-8.62 8.622L4.128 16l6.5-6.5-6.5-6.5L6.25.88Z" clipRule="evenodd"></path>
                                    ...
                                    <div role="listitem" className="collection__item is-posts is-2col w-dyn-item" style={{ opacity: 1 }}>
                                        <div data-hover-parent="" className="post-card">
                                            ...
                                            <a data-hover="" href="/project/droney" className="post-card__title-link w-inline-block">
                                                <h2 className="post-card__title">Distinctive solutions for Droney's high-tech logistics vision <span className="post-card__span-icons"></span><span className="post-card__span-icons">
                                                    <div className="post-card__icons">
                                                        <div className="post-card__icon opacity-0 w-embed">
                                                            <svg aria-hidden="true" role="img" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19 19" width="100%" height="100%">
                                                                <path fillRule="evenodd" d="M6.25.879 14.871 9.5l-8.62 8.622L4.128 16l6.5-6.5-6.5-6.5L6.25.88Z" clipRule="evenodd"></path>
                                    ...
                                    <div role="listitem" className="collection__item is-posts is-2col w-dyn-item" style={{ opacity: 1 }}>
                                        <div data-hover-parent="" className="post-card">
                                            ...
                                            <a data-hover="" href="/project/stone" className="post-card__title-link w-inline-block">
                                                <h2 className="post-card__title">Building a strong digital presence for a branding studio with a big impact <span className="post-card__span-icons"></span><span className="post-card__span-icons">
                                                    <div className="post-card__icons">
                                                        <div className="post-card__icon opacity-0 w-embed">
                                                            <svg aria-hidden="true" role="img" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19 19" width="100%" height="100%">
                                                                <path fillRule="evenodd" d="M6.25.879 14.871 9.5l-8.62 8.622L4.128 16l6.5-6.5-6.5-6.5L6.25.88Z" clipRule="evenodd"></path>
                                    ...
                                    <div role="listitem" className="collection__item is-posts is-2col w-dyn-item" style={{ opacity: 1 }}>
                                        <div data-hover-parent="" className="post-card">
                                            ...
                                            <a data-hover="" href="/project/agrinex" className="post-card__title-link w-inline-block">
                                                <h2 className="post-card__title">UI/UX for a web platform with all farming needs in one place<span className="post-card__span-icons"></span><span className="post-card__span-icons">
                                                    <div className="post-card__icons">
                                                        <div className="post-card__icon opacity-0 w-embed">
                                                            <svg aria-hidden="true" role="img" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19 19" width="100%" height="100%">
                                                                <path fillRule="evenodd" d="M6.25.879 14.871 9.5l-8.62 8.622L4.128 16l6.5-6.5-6.5-6.5L6.25.88Z" clipRule="evenodd"></path>
                                    ...
                                    <div role="listitem" className="collection__item is-posts is-2col w-dyn-item" style={{ opacity: 1 }}>
                                        <div data-hover-parent="" className="post-card">
                                            ...
                                            <a data-hover="" href="/project/umano" className="post-card__title-link w-inline-block">
                                                <h2 className="post-card__title">Unlocking the full potential of the Umano product — from design to development<span className="post-card__span-icons"></span><span className="post-card__span-icons">
                                                    <div className="post-card__icons">
                                                        <div className="post-card__icon opacity-0 w-embed">
                                                            <svg aria-hidden="true" role="img" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19 19" width="100%" height="100%">
                                                                <path fillRule="evenodd" d="M6.25.879 14.871 9.5l-8.62 8.622L4.128 16l6.5-6.5-6.5-6.5L6.25.88Z" clipRule="evenodd"></path>
                                    ...
                                    <div role="listitem" className="collection__item is-posts is-2col w-dyn-item" style={{ opacity: 1 }}>
                                        <div data-hover-parent="" className="post-card">
                                            ...
                                            <a data-hover="" href="/project/versus" className="post-card__title-link w-inline-block">
                                                <h2 className="post-card__title">Strong and memorable brand solutions winning over tennis lovers<span className="post-card__span-icons"></span><span className="post-card__span-icons">
                                                    <div className="post-card__icons">
                                                        <div className="post-card__icon opacity-0 w-embed">
                                                            <svg aria-hidden="true" role="img" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19 19" width="100%" height="100%">
                                                                <path fillRule="evenodd" d="M6.25.879 14.871 9.5l-8.62 8.622L4.128 16l6.5-6.5-6.5-6.5L6.25.88Z" clipRule="evenodd"></path>
                                    ...
                                    <div role="listitem" className="collection__item is-posts is-2col w-dyn-item" style={{ opacity: 1 }}>
                                        <div data-hover-parent="" className="post-card">
                                            ...
                                            <a data-hover="" href="/project/nettra-media" className="post-card__title-link w-inline-block">
                                                <h2 className="post-card__title">Animating the digital dreams for the Nettra Media website<span className="post-card__span-icons"></span><span className="post-card__span-icons">
                                                    <div className="post-card__icons">
                                                        <div className="post-card__icon opacity-0 w-embed">
                                                            <svg aria-hidden="true" role="img" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19 19" width="100%" height="100%">
                                                                <path fillRule="evenodd" d="M6.25.879 14.871 9.5l-8.62 8.622L4.128 16l6.5-6.5-6.5-6.5L6.25.88Z" clipRule="evenodd"></path>
                                    ...
                                    <div role="listitem" className="collection__item is-posts is-2col w-dyn-item" style={{ opacity: 1 }}>
                                        <div data-hover-parent="" className="post-card">
                                            ...
                                            <a data-hover="" href="/project/nanocorp" className="post-card__title-link w-inline-block">
                                                <h2 className="post-card__title">Designing tomorrow's trading experience for NanoCorp's platform<span className="post-card__span-icons"></span><span className="post-card__span-icons">
                                                    <div className="post-card__icons">
                                                        <div className="post-card__icon opacity-0 w-embed">
                                                            <svg aria-hidden="true" role="img" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19 19" width="100%" height="100%">
                                                                <path fillRule="evenodd" d="M6.25.879 14.871 9.5l-8.62 8.622L4.128 16l6.5-6.5-6.5-6.5L6.25.88Z" clipRule="evenodd"></path>
                                ...
                                <div role="navigation" aria-label="List" className="w-pagination-wrapper posts-pagination" style={{ opacity: 1 }}>
                                    <a href="?be99beb4_page=0" aria-label="Previous Page" className="w-pagination-previous posts-pagination__btn is-previews" style={{ display: 'none' }}>
                                    ...
                                    <link rel="prerender" href="?be99beb4_page=2"></link>
                                </div>
                                <div className="hide">
                    ...
                    <div className="card__container">
                        <div className="columns mod--card-head">
                            <div className="columns__col is-1-old mod--heading-works">
                                <h2 className="heading-1">Top on Dribbble</h2>
                            </div>
                            <div className="columns__col is-2-old mod--works-heading">
                                <p className="works__subheading hide-tablet">Our company offers personalized design and development solutions that prioritize user experience.</p>
                                <a data-hover="" href="https://dribbble.com/halolab" target="_blank" className="works__more mod--ondribble w-inline-block" style={{ willChange: 'transform', transform: 'translate3d(0rem, 0rem, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg)', transformStyle: 'preserve-3d' }}>
                                    <div className="works__more-texts mod--dribble">
                                        <div className="overflow-hidden">
                                            <div data-hover-elem="" className="button__texts">
                                                <div className="button__text">GET</div>
                                                <div className="button__text is-absolute">GET</div>
                                            </div>
                                        </div>
                                        <div className="overflow-hidden">
                                            <div data-hover-elem="" className="button__texts">
                                                <div className="button__text">inspired</div>
                                                <div className="button__text is-absolute">inspired</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="works__more-icon">
                                        <div data-hover-elem="" className="button__icons mod--projects-dribble">
                                            <div data-hover-elem="" className="button__icon-anim">
                                                <div className="icon-regular is-size-16-mobile w-embed">
                                                    <svg aria-hidden="true" role="img" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="100%" height="100%">
                                                        <path fillRule="evenodd" d="M2.398 12.01c0-5.295 4.308-9.6 9.6-9.6 5.293 0 9.6 4.305 9.6 9.6 0 5.292-4.307 9.597-9.6 9.597-5.292 0-9.6-4.305-9.6-9.598Zm7.679-7.96c.224.304 1.715 2.33 3.058 4.802 2.917-1.094 4.151-2.753 4.298-2.964a8.168 8.168 0 0 0-5.435-2.066c-.662 0-1.305.081-1.921.228Zm-1.564.553a8.222 8.222 0 0 0-4.54 5.74h.121c.721 0 3.892-.051 7.46-1a52.062 52.062 0 0 0-3.04-4.74Zm5.8 6.656c.061.14.12.28.178.421 2.73-.343 5.44.207 5.71.266a8.156 8.156 0 0 0-1.852-5.107c-.173.234-1.545 1.994-4.579 3.232.191.39.374.786.544 1.188Zm-2.084-.656C8.6 11.688 5.067 11.77 4.06 11.77c-.13 0-.217-.002-.258-.002-.002.085-.002.167-.002.25 0 2.108.797 4.031 2.107 5.482.185-.316 2.437-4.042 6.665-5.407.106-.037.215-.07.321-.099a25.159 25.159 0 0 0-.664-1.391Zm2.755 2.368c1.074 2.948 1.51 5.346 1.595 5.845a8.22 8.22 0 0 0 3.514-5.494c-.283-.09-2.54-.762-5.109-.351Zm-8.02 5.518a8.175 8.175 0 0 0 5.034 1.731 8.188 8.188 0 0 0 3.205-.65c-.123-.72-.6-3.227-1.751-6.218l-.054.018c-4.626 1.612-6.286 4.818-6.434 5.12Z" clipRule="evenodd"></path>
                                                    </svg>
                                                </div>
                                                <div className="icon-regular is-absolute is-size-16-mobile w-embed">
                                                    <svg aria-hidden="true" role="img" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="100%" height="100%">
                                                        <path fillRule="evenodd" d="M2.398 12.01c0-5.295 4.308-9.6 9.6-9.6 5.293 0 9.6 4.305 9.6 9.6 0 5.292-4.307 9.597-9.6 9.597-5.292 0-9.6-4.305-9.6-9.598Zm7.679-7.96c.224.304 1.715 2.33 3.058 4.802 2.917-1.094 4.151-2.753 4.298-2.964a8.168 8.168 0 0 0-5.435-2.066c-.662 0-1.305.081-1.921.228Zm-1.564.553a8.222 8.222 0 0 0-4.54 5.74h.121c.721 0 3.892-.051 7.46-1a52.062 52.062 0 0 0-3.04-4.74Zm5.8 6.656c.061.14.12.28.178.421 2.73-.343 5.44.207 5.71.266a8.156 8.156 0 0 0-1.852-5.107c-.173.234-1.545 1.994-4.579 3.232.191.39.374.786.544 1.188Zm-2.084-.656C8.6 11.688 5.067 11.77 4.06 11.77c-.13 0-.217-.002-.258-.002-.002.085-.002.167-.002.25 0 2.108.797 4.031 2.107 5.482.185-.316 2.437-4.042 6.665-5.407.106-.037.215-.07.321-.099a25.159 25.159 0 0 0-.664-1.391Zm2.755 2.368c1.074 2.948 1.51 5.346 1.595 5.845a8.22 8.22 0 0 0 3.514-5.494c-.283-.09-2.54-.762-5.109-.351Zm-8.02 5.518a8.175 8.175 0 0 0 5.034 1.731 8.188 8.188 0 0 0 3.205-.65c-.123-.72-.6-3.227-1.751-6.218l-.054.018c-4.626 1.612-6.286 4.818-6.434 5.12Z" clipRule="evenodd"></path>
                                                    </svg>
                                                </div>
                                            </div>
                                            <div data-hover-elem="" className="button__bg bg-color-pink"></div>
                                        </div>
                                </div>
                                </a>
                            </div>
                        </div>
                        <div className="columns mod--projects-dribble">
                            <div className="columns__col is-1-old mod--projects-dribble">
                                <div className="dribble-card__border">
                                    <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/64d25fb852d34e3c9b08f5ca_label-dribble.svg" loading="lazy" alt="" className="dribble-card__label-dribble is-1" />
                                    <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/64d2604252d49180b380b54e_label-dribble_tablet.svg" loading="lazy" alt="" className="dribble-card__label-dribble is-2" />
                                    <div className="dribble-card__advant">
                                        <div className="text-size-80 text-weight-medium">1,000+</div>
                                        <div className="heading-6 text-size-tablet-16">Impressive Dribbble shots, showcasing our design expertise and prowess</div>
                                    </div>
                                </div>
                            </div>
                            <div data-mask="on-dribble" className="columns__col is-2-old mod--projects-dribble">
                                <video autoPlay loop muted loading="lazy" className="dribble-card__video">
                                    <source type="video/mp4" src="https://d3vlq52qrgdnc2.cloudfront.net/Projects-Carusel.mp4" />
                                </video>
                            </div>
                        </div>
                    </div>
                ...
                <div className="container">
                    <div data-anim-trigger="load" className="columns is-heading">
                        <div data-award-heading-col="" data-anim-delay="" className="columns__col mod--heading is-1 hide-mobile-landscape">
                            <div className="button-label">Our Awards</div>
                        </div>
                        <div data-anim-delay="" className="columns__col mod--heading w-clearfix">
                            <div className="space-heading-4"></div>
                            <p data-anim-split="" className="heading-4">Our award-winning company creates exceptional, user-centric products that captivate audiences and drive results.</p>
                        </div>
                    </div>
                    <div className="awards-container">
                        <div data-glow-container="" data-swiper="awards-runline" className="swiper mod--awards">
                                ...
                                <div className="swiper-slide mod--awards">
                                    <div data-hover="" className="circles__block-wrap">
                                        <div className="circles__block">
                                            <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/65df2245169d0dbda30cc38c_award-clutch.svg" loading="lazy" alt="Top 100 companies worldwide by Clutch" className="circles__logo" />
                                            <div data-hover-elem="" className="circles__border">
                                                <div data-glow="" data-mask="awards" className="circles__border-anim"></div>
                                            </div>
                                            <div className="circles__text">Top 100 companies worldwide by Clutch</div>
                                        </div>
                                    </div>
                                </div>
                                <div className="swiper-slide mod--awards">
                                    <div data-hover="" className="circles__block-wrap">
                                        <div className="circles__block">
                                            <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/65df2245fbe6c26a04e38642_award-awwwards.svg" loading="lazy" alt="17 Honorable Mentions by Awwwards" className="circles__logo" />
                                            <div data-hover-elem="" className="circles__border">
                                                <div data-glow="" data-mask="awards" className="circles__border-anim"></div>
                                            </div>
                                            <div className="circles__text">17 Honorable Mentions<br />by Awwwards</div>
                                        </div>
                                    </div>
                                </div>
                                <div className="swiper-slide mod--awards">
                                    <div data-hover="" className="circles__block-wrap">
                                        <div className="circles__block">
                                            <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/65df2248b0570f11feddea87_award-upwork.svg" loading="lazy" alt="100% Job Success on Upwork" className="circles__logo" />
                                            <div data-hover-elem="" className="circles__border">
                                                <div data-glow="" data-mask="awards" className="circles__border-anim"></div>
                                            </div>
                                            <div className="circles__text">100% Job Success on Upwork</div>
                                        </div>
                                    </div>
                                </div>
                                <div className="swiper-slide mod--awards">
                                    <div data-hover="" className="circles__block-wrap">
                                        <div className="circles__block">
                                            <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/65df2245169d0dbda30cc38c_award-clutch.svg" loading="lazy" alt="Top 20 Digital Design Company by Clutch" className="circles__logo" />
                                            <div data-hover-elem="" className="circles__border">
                                                <div data-glow="" data-mask="awards" className="circles__border-anim"></div>
                                            </div>
                                            <div className="circles__text">Top 20 Digital Design Company by Clutch</div>
                                        </div>
                                    </div>
                                </div>
                                <div className="swiper-slide mod--awards">
                                    <div data-hover="" className="circles__block-wrap">
                                        <div className="circles__block">
                                            <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/65df224561b22f2fb2303d11_award-behance.svg" loading="lazy" alt="17 features on the Behance platform" className="circles__logo active" />
                                            <div data-hover-elem="" className="circles__border active">
                                                <div data-glow="" data-mask="awards" className="circles__border-anim"></div>
                                            </div>
                                            <div className="circles__text">17 features on the Behance platform</div>
                                        </div>
                                    </div>
                                </div>
                                <div className="swiper-slide mod--awards">
                                    <div data-hover="" className="circles__block-wrap">
                                        <div className="circles__block">
                                            <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/65df22453a88d0237804696b_award-dribbble.svg" loading="lazy" alt="#1 Team on Dribbble platform" className="circles__logo" />
                                            <div data-hover-elem="" className="circles__border">
                                                <div data-glow="" data-mask="awards" className="circles__border-anim"></div>
                                            </div>
                                            <div className="circles__text">#1 Team on Dribbble platform</div>
                                        </div>
                                    </div>
                                </div>
                                <div className="swiper-slide mod--awards">
                                    <div data-hover="" className="circles__block-wrap">
                                        <div className="circles__block">
                                            <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/65df2245947339c4d4a52e5d_award-css.svg" loading="lazy" alt="14 Special Kudos CSS Design Award" className="circles__logo" />
                                            <div data-hover-elem="" className="circles__border">
                                                <div data-glow="" data-mask="awards" className="circles__border-anim"></div>
                                            </div>
                                            <div className="circles__text">14 Special Kudos CSS Design Award</div>
                                        </div>
                                    </div>
                                </div>
                                <div className="swiper-slide mod--awards">
                                    <div data-hover="" className="circles__block-wrap">
                                        <div className="circles__block">
                                            <img src="https://cdn.prod.website-files.com/63f38a8c92397a024fcb9ae8/65df2245b492a6ee900345c1_award-64.svg" loading="lazy" alt="Other awards and recognitions" className="circles__logo" />
                                            <div data-hover-elem="" className="circles__border">
                                                <div data-glow="" data-mask="awards" className="circles__border-anim"></div>
                                            </div>
                                            <div className="circles__text">Other awards and recognitions</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
