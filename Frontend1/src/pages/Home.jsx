          ...
          <span className="position-relative">
            <svg className="position-absolute home-diamond-1" width="20" height="26" viewBox="0 0 23 29" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g clipPath="url(#clip0_1123_13950)">
                ...
                <path className="stroke-path" d="M12.6641 0.949173C13.4875 7.02885 16.0125 13.114 20.9199 17.0305C21.2987 17.3364 21.908 17.2327 22.3252 17.0524C22.5283 16.965 23.2748 16.5116 22.8906 16.2057C18.0435 12.3329 15.6008 6.38428 14.7884 0.381081C14.6951 -0.323571 12.5598 0.157122 12.6696 0.949173H12.6641Z" fill="#000617"></path>
                <path className="stroke-path" d="M0.0974525 14.802C4.18146 18.6858 7.82633 23.1814 9.53898 28.6165C9.76953 29.3539 11.8884 28.764 11.6578 28.0484C9.91225 22.5313 6.21249 17.9211 2.06261 13.9717C1.52466 13.4637 -0.473431 14.2558 0.0919632 14.7965H0.0974525V14.802Z" fill="#000617"></path>
                <path className="stroke-path" d="M12.4005 28.4682C14.9804 23.9289 18.4551 19.9632 22.6764 16.866C23.0496 16.5929 22.863 16.216 22.4733 16.1177C21.9573 15.992 21.3809 16.216 20.9747 16.5164C16.6601 19.6846 13.0647 23.776 10.4243 28.419C9.93578 29.2821 12.0546 29.0691 12.4005 28.4627V28.4682Z" fill="#000617"></path>
              </g>
              <defs>
            ...
            <svg className="position-absolute home-diamond-2" width="10" height="14" viewBox="0 0 13 17" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g clipPath="url(#clip0_1123_13955)">
                ...
                <path className="stroke-path" d="M7.15625 0.554998C7.62164 4.11895 9.04885 7.6861 11.8226 9.98201C12.0367 10.1613 12.3811 10.1005 12.6169 9.99482C12.7317 9.94358 13.1536 9.67781 12.9364 9.49849C10.1968 7.22819 8.81615 3.7411 8.35697 0.221978C8.30422 -0.191094 7.0973 0.0906917 7.15935 0.554998H7.15625Z" fill="#000617"></path>
                <path className="stroke-path" d="M0.0594976 8.6761C2.36785 10.9528 4.42799 13.5881 5.39601 16.7742C5.52632 17.2065 6.72394 16.8607 6.59363 16.4412C5.60699 13.2071 3.51582 10.5045 1.17024 8.18938C0.86618 7.89158 -0.263175 8.35589 0.056395 8.6729H0.0594976V8.6761Z" fill="#000617"></path>
                <path className="stroke-path" d="M7.00963 16.6866C8.46787 14.0257 10.4318 11.701 12.8177 9.88536C13.0287 9.72526 12.9232 9.50431 12.703 9.44668C12.4113 9.37303 12.0855 9.50431 11.8559 9.68043C9.41727 11.5377 7.38505 13.936 5.89269 16.6578C5.61656 17.1638 6.81417 17.0389 7.00963 16.6834V16.6866Z" fill="#000617"></path>
              </g>
              <defs>
